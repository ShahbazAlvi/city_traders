...
class _GRNScreenState extends State<GRNScreen>
  ...
  // Widget _buildSummaryStrip(GRNProvider provider) {
  //   final totalAmount = provider.grnList.fold<double>(
  //       0, (s, g) => s + (g.totalAmount?.toDouble() ?? 0));
  //   final totalItems =
  //   provider.grnList.fold<int>(0, (s, g) => s + (g.totalItems ?? 0));
  //   final totalQty =
  //   provider.grnList.fold<num>(0, (s, g) => s + (g.totalQty ?? 0));
  //
  //   return Container(
  ...
  //         _summaryItem(
  //           label: "Total GRNs",
  //           value: provider.grnList.length.toString(),
