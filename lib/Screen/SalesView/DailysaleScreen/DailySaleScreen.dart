        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Empty State — no salesman gate anymore
              if (!provider.isLoading && provider.reportData == null)
                Center(
                  child: Padding(
                    padding: const EdgeInsets.all(32),
  ...
  Widget buildReport(DailySaleReportProvider provider) {
    ...
    return Column(
      ...
      children: [
        ...
        if (reportData.salesItems.isEmpty)
          _buildEmptySection("No product sales for this date"),
          ...
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: reportData.paymentsReceived.map((item) {
                  final balance =
                      item.totalInvoiceAmount - item.totalReceived;
                  return DataRow(cells: [
                    DataCell(
                      Container(
                        constraints: const BoxConstraints(maxWidth: 150),
        ...
        if (reportData.paymentsReceived.isEmpty)
          _buildEmptySection("No customer payments for this date"),
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            ...
            color:
            isLarge ? const Color(0xFF1E293B) : const Color(0xFF64748B),
          ),
        ),
        Text(
          value,
