...
//     final provider = context.watch<CustomerPaymentProvider>(); // ✅ correct provider
//
...
//                 color: AppColors.primary),
//           ),
//           items: provider.customerInvoices.map((inv) {  // ✅ from correct provider
...
//                     ),
//                     child: Text(
//                       "Rs ${inv.outstandingBalance?.toStringAsFixed(0) ?? inv.netTotal.toStringAsFixed(0)}",
//                       style: TextStyle(
//                           color: AppColors.primary,
//                           fontWeight: FontWeight.bold,
//                           fontSize: 13),
...
//                   (invoice!.outstandingBalance ?? invoice.netTotal)
//                       .toStringAsFixed(0);
//             });
//           },
//         ),
...
// screens/Recovery/AddRecoveryScreen.dart
