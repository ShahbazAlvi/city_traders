...
//
//   // ✅ New: override customer & salesman from selected order
...
//
//     // ✅ Pre-fill customer and salesman from the selected order
//     final provider = Provider.of<OrderTakingProvider>(context, listen: false);
...
//       // ✅ Use overridden customer/salesman if changed
...
//   }
//
//   // ✅ Customer Dropdown Widget
//   Widget _buildCustomerDropdown() {
//     return Consumer<CustomerProvider>(
//       builder: (context, customerProvider, _) {
//         if (customerProvider.isLoading) {
//           return _buildDropdownSkeleton("Customer");
//         }
...
//       ),
//       suffixIcon: Icon(Icons.arrow_drop_down, color: Colors.grey.shade500),
//     );
//   }
//
...
//             const SizedBox(height: 12),
//
//             // ✅ Customer & Salesman dropdowns — shown once order is selected
//             if (provider.selectedOrder != null) ...[
//               Row(
//                 children: [
...
//                   itemCount:
//                   provider.selectedOrder!.details.length,
//                   itemBuilder: (context, index) {
//                     final item =
